...
(function (window, $, moment, YoHours, jSmart, Jed) {
	...
	YoHours.templates = {
		...
		bootstrap4: { // custom inputGroup
			inputGroup: '<div class="input-group">\n\t<input type="text" class="form-control" id="toReplace">\n\t<div class="input-group-append">\n\t\t<button id="{$prefix|default:\'\'}yo-hours-toggle" class="button-outline small secondary" type="button" role="button" data-toggle="collapse"\n\t\t\t\tdata-target="#{$prefix|default:\'\'}yo-hours-collapse" aria-expanded="false"\n\t\t\t\taria-controls="{$prefix|default:\'\'}yo-hours-collapse">\n\t\t\t{$iconClock|default:\'<strong>&#x1f556;</strong>\'}\n\t\t</button><button id="{$prefix|default:\'\'}yo-hours-range-delete" class="button-outline small warning" type="button">\n\t\t\t\t\t\t{$iconTrash|default:\'&#x1F5D1;\'}\n\t\t\t\t\t</button>\n\t</div>\n</div>\n<div id="{$prefix|default:\'\'}yo-hours-collapse" class="yo-hours-collapse collapse show">\n\t<div id="{$prefix|default:\'\'}yo-hours-range-nav"></div>\n\n\t<div id="{$prefix|default:\'\'}yo-hours-calendar" class="yo-hours-calendar" style="display:none"></div>\n</div>',
...
//				}
	...
	YoHours.view.CalendarView.prototype.show = function (dateRange) {
		...
		this._calendar = new FullCalendar.Calendar($calendar.get(0), {
			...
			allDayText: '24h/24', // custom
			allDaySlot: true,
			slotDuration: '00:30:00', // custom
			slotLabelFormat: {
				hour: '2-digit',
				minute: '2-digit',
				hour12: false // custom
