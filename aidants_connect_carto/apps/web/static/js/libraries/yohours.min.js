var YoHours=YoHours||{};
(function(w,m,t,c,x,z){function y(a){a=parseInt(a);return 0===a?6:a-1}var p;x.prototype.registerPlugin("modifier","t",function(a,b){var c=a;p instanceof z&&(void 0===b&&(b="yohours"),c=p.translate(a).withContext(b).fetch());return c});w.Array.prototype.equals=function(a){if(!a||this.length!==a.length)return!1;for(var b=0,c=this.length;b<c;b++)if(this[b]instanceof Array&&a[b]instanceof Array){if(!this[b].equals(a[b]))return!1}else if(this[b]!==a[b])return!1;return!0};w.Array.prototype.contains=function(a){for(var b=
	this.length;b--;)if(this[b]===a)return!0;return!1};c=m.extend(c,{counter:0,DAYS:{MONDAY:0,TUESDAY:1,WEDNESDAY:2,THURSDAY:3,FRIDAY:4,SATURDAY:5,SUNDAY:6},OSM_DAYS:"Mo Tu We Th Fr Sa Su".split(" "),IRL_DAYS:"Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "),OSM_MONTHS:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),IRL_MONTHS:"January February March April May June July August September October November December".split(" "),MONTH_END_DAY:[31,28,31,30,31,30,31,31,30,31,
	...
	this._end=e;this._dayEnd||this._end||(this._dayEnd=c.DAYS_MAX,this._end=c.MINUTES_MAX)};c.Interval.prototype.getStartDay=function(){return parseInt(this._dayStart)};c.Interval.prototype.getEndDay=function(){return parseInt(this._dayEnd)};c.Interval.prototype.getFrom=function(){return parseInt(this._start)};c.Interval.prototype.getTo=function(){return parseInt(this._end)};c.WideInterval=function(){this._type=this._end=this._start=null};c.WideInterval.prototype.day=function(a,b,c,e){if(void 0===a||
	void 0===b)throw Error(p.translate("Start day and month can't be null").withContext("yohours/notifications").fetch());this._start={day:a,month:b};this._end=c&&e&&(c!==a||e!==b)?{day:c,month:e}:null;this._type="day";return this};c.WideInterval.prototype.week=function(a,b){if(void 0===a)throw Error(p.translate("Start week can't be null").withContext("yohours/notifications").fetch());this._start={week:a};this._end=b&&b!==a?{week:b}:null;this._type="week";return this};c.WideInterval.prototype.month=function(a,
																																																																																																																																 b){if(void 0===a)throw Error(p.translate("Start month can't be null").withContext("yohours/notifications").fetch());this._start={month:a};this._end=b&&b!==a?{month:b}:null;this._type="month";return this};c.WideInterval.prototype.holiday=function(a){if(void 0===a||"PH"!==a&&"SH"!==a&&"easter"!==a)throw Error(p.translate("Invalid holiday, must be PH, SH or easter").withContext("yohours/notifications").fetch());this._start={holiday:a};this._end=null;this._type="holiday";return this};c.WideInterval.prototype.always=
	...
	c.WideInterval.prototype.getTimeForHumans=function(){switch(this._type){case "day":var a=null!=this._end?p.translate("every week from %s %u to %s %u").withContext("yohours/timespan").fetch(p.translate(c.IRL_MONTHS[this._start.month-1]).withContext("yohours").fetch(),this._start.day,this._start.month!==this._end.month?p.translate(c.IRL_MONTHS[this._end.month-1]).withContext("yohours").fetch():"",this._end.day):p.translate("day %s %u").withContext("yohours/timespan").fetch(p.translate(c.IRL_MONTHS[this._start.month-
	1]).withContext("yohours").fetch(),this._start.day);break;case "week":a=null!=this._end?p.translate("every week from week %u to %u").withContext("yohours/timespan").fetch(this._start.week,this._end.week):p.translate("week %u").withContext("yohours/timespan").fetch(this._start.week);break;case "month":a=null!=this._end?p.translate("every week from %s to %s").withContext("yohours/timespan").fetch(p.translate(c.IRL_MONTHS[this._start.month-1]).withContext("yohours").fetch(),p.translate(c.IRL_MONTHS[this._end.month-
	1]).withContext("yohours").fetch()):p.translate("every week in %s").withContext("yohours/timespan").fetch(p.translate(c.IRL_MONTHS[this._start.month-1]).withContext("yohours").fetch());break;case "holiday":if("SH"===this._start.holiday)a=p.translate("every week during school holidays").withContext("yohours/timespan").fetch();else if("PH"===this._start.holiday)a=p.translate("every public holidays").withContext("yohours/timespan").fetch();else if("easter"===this._start.holiday)a=p.translate("each easter day").withContext("yohours/timespan").fetch();
	else throw Error(p.translate("Invalid holiday type: %s").withContext("yohours/notifications").fetch(this._start.holiday));break;case "always":a=p.translate("every week of year").withContext("yohours/timespan").fetch();break;default:a=p.translate("invalid time").withContext("yohours/timespan").fetch()}return a};c.WideInterval.prototype.getTimeSelector=function(){switch(this._type){case "day":var a=c.OSM_MONTHS[this._start.month-1]+" "+(10>this._start.day?"0":"")+this._start.day;null!=this._end&&(a=
	...
	this._end.week?b=!0:null==a._end&&(null!=this._end&&a._start.week<=this._end.week||a._start.week===this._start.week)&&(b=!0)):"month"===this._type&&("month"===a._type?a._start.month>=this._start.month&&(null!=a._end&&null!=this._end&&a._end.month<=this._end.month?b=!0:null==a._end&&(null!=this._end&&a._start.month<=this._end.month||a._start.month===this._start.month)&&(b=!0)):"day"===a._type&&(null!=a._end?null==this._end?a._start.month===this._start.month&&a._end.month===this._start.month&&(1<=a._start.day&&
		...
		this._intervals[d].getEndDay()===c.DAYS_MAX&&this._intervals[d].getTo()===c.MINUTES_MAX)a=this._intervals[d].getFrom(),h=this._intervals[d].getTo();if(null!==a&&null!==h)for(;a<=h;a++)b[a]=!0;else throw console.log(this._intervals[d].getFrom()+" "+this._intervals[d].getTo()+" "+this._intervals[d].getStartDay()+" "+this._intervals[d].getEndDay()),Error(p.translate("Invalid interval").withContext("yohours/notifications").fetch());}return b};c.Day.prototype.getIntervals=function(a){if(a){a=this.getAsMinutesArray();
	...
	c.OhDate.prototype.addOverwrittenWeekday=function(a){this._wdOver.contains(a)||this._weekdays.contains(a)||(this._wdOver.push(a),this._wdOver=this._wdOver.sort())};c.OhRule=function(){this._date=[];this._time=[]};c.OhRule.prototype.getDate=function(){return this._date};c.OhRule.prototype.getTime=function(){return this._time};c.OhRule.prototype.get=function(){var a,b="";if(1<this._date.length||""!==this._date[0].getWideValue()){var c=0;for(a=this._date.length;c<a;c++)0<c&&(b+=","),b+=this._date[c].getWideValue()}0<
	this._date.length&&(c=this._date[0].getWeekdays(),0<c.length&&(b+=" "+c));if(0<this._time.length)for(b+=" ",c=0,a=this._time.length;c<a;c++)0<c&&(b+=","),b+=this._time[c].get();else b+=" off";"00:00-24:00"===b.trim()&&(b="24/7");return b.trim()};c.OhRule.prototype.sameTime=function(a){if(void 0===a||null==a||a.getTime().length!==this._time.length)return!1;for(var b=0,c=this._time.length;b<c;b++)if(!this._time[b].equals(a.getTime()[b]))return!1;return!0};c.OhRule.prototype.isOff=function(){return 0===
	...
	c.OhRule.prototype.addDate=function(a){if(null===a||void 0===a||!(a instanceof c.OhDate))throw Error(p.translate("Invalid parameter").withContext("yohours/notifications").fetch());if(0===this._date.length||"always"!==this._date[0].getWideType()&&this._date[0].sameKindAs(a))this._date.push(a);else if(1!==this._date.length||"always"!==this._date[0].getWideType()||!this._date[0].sameWd(a.getWd()))throw Error(p.translate("This date can't be added to this rule").withContext("yohours/notifications").fetch());
	};c.OhRule.prototype.addTime=function(a){if(0!==this._time.length&&"off"===this._time[0].get()||this._time.contains(a))throw Error(p.translate("This time can't be added to this rule").withContext("yohours/notifications").fetch());this._time.push(a)};c.OpeningHoursBuilder=function(){};c.OpeningHoursBuilder.prototype.build=function(a){var b=[],d;var e=0;for(var h=a.length;e<h;e++){var g=a[e];if(void 0!==g){var f=d=null;for(var l=e-1;0<=l&&null==d;){if(void 0!==a[l]){var k=a[l].isGeneralFor(g);a[l].hasSameTypical(g)&&
	(a[l].getInterval().equals(g.getInterval())||k)?d=l:k&&a[l].definesTypicalWeek()&&g.definesTypicalWeek()&&(f=l)}l--}if(0===e||null==d)for(g=g.definesTypicalWeek()?null!=f?this._buildWeekDiff(g,a[f]):this._buildWeek(g):this._buildDay(g),f=0,l=g.length;f<l;f++){d=g[f];var n=!1;for(k=0;!n&&k<b.length;)if(b[k].sameTime(d))try{for(var u=0,p=d.getDate().length;u<p;u++)b[k].addDate(d.getDate()[u]);n=!0}catch(q){"holiday"===d.getDate()[0].getWideType()&&"PH"===d.getDate()[0].getWideValue()&&"always"===b[k].getDate()[0].getWideType()?
		(b[k].addPhWeekday(),n=!0):"holiday"===b[k].getDate()[0].getWideType()&&"PH"===b[k].getDate()[0].getWideValue()&&"always"===d.getDate()[0].getWideType()?(d.addPhWeekday(),b[k]=d,n=!0):k++}else k++;n||b.push(d);if(f===l-1&&d.hasOverwrittenWeekday()){k=new c.OhRule;for(n=0;n<d.getDate().length;n++)k.addDate(new c.OhDate(d.getDate()[n].getWideValue(),d.getDate()[n].getWideType(),d.getDate()[n].getWdOver()));k.addTime(new c.OhTime);g.push(k);l++}}}}a="";k=0;for(h=b.length;k<h;k++)0<k&&(a+="; "),a+=b[k].get();
	...
	g;h++)0===e[h]&&(e[h]=-d-1,a[d].addOverwrittenWeekday(h));a[d].addWeekday(g);b.push(a[d])}}return b=this._mergeDays(b)};c.OpeningHoursBuilder.prototype._buildWeekDiff=function(a,b){var d,e,h=a.getTypical().getIntervalsDiff(b.getTypical()),g=this._createTimeIntervals(a.getInterval().getTimeSelector(),a.getInterval().getType(),h.open),f=g[0],l=g[1];g=g[2];var k=0;for(e=h.closed.length;k<e;k++){var n=h.closed[k];for(d=n.getStartDay();d<=n.getEndDay();d++)g[d].addTime(new c.OhTime)}g=this._nightMonSun(g,
		...
		l){for(d=k+1;d<e;d++)0===h[d]&&(h[d]=-k-1,0<g[d].getTime().length&&g[k].addOverwrittenWeekday(d));g[k].addWeekday(e);f.push(g[k])}}return f=this._mergeDays(f)};c.OpeningHoursBuilder.prototype._mergeDays=function(a){if(0===a.length)return a;var b=[];b.push(a[0]);for(var c,e=1;e<a.length;e++){var h=!1;for(c=0;!h&&c<e;){if(a[c].sameTime(a[e])){h=a[e].getDate()[0].getWd();for(var g=0;g<h.length;g++)a[c].addWeekday(h[g]);h=!0}c++}h||b.push(a[e])}return b};c.OpeningHoursBuilder.prototype._createTimeIntervals=
		function(a,b,d){var e,h=-1,g=-1,f=[];for(e=0;7>e;e++)f.push(new c.OhRule),f[e].addDate(new c.OhDate(a,b,[e]));e=0;for(b=d.length;e<b;e++)if(a=d[e],void 0!==a){a.getStartDay()===c.DAYS_MAX&&a.getEndDay()===c.DAYS_MAX&&a.getTo()===c.MINUTES_MAX&&(g=a.getFrom());0===a.getStartDay()&&0===a.getEndDay()&&0===a.getFrom()&&(h=a.getTo());try{if(a.getStartDay()===a.getEndDay())f[a.getStartDay()].addTime(new c.OhTime(a.getFrom(),a.getTo()));else if(1===a.getEndDay()-a.getStartDay())a.getFrom()>a.getTo()?f[a.getStartDay()].addTime(new c.OhTime(a.getFrom(),
			a.getTo())):(f[a.getStartDay()].addTime(new c.OhTime(a.getFrom(),c.MINUTES_MAX)),f[a.getEndDay()].addTime(new c.OhTime(0,a.getTo())));else for(var l=a.getStartDay(),k=a.getEndDay();l<=k;l++)l===a.getStartDay()?f[l].addTime(new c.OhTime(a.getFrom(),c.MINUTES_MAX)):l===a.getEndDay()?f[l].addTime(new c.OhTime(0,a.getTo())):f[l].addTime(new c.OhTime(0,c.MINUTES_MAX))}catch(n){console.warn(n)}}return[h,g,f]};c.OpeningHoursBuilder.prototype._nightMonSun=function(a,b,d){0<=b&&0<=d&&b<d&&(a[0].getTime().sort(this._sortOhTime),
		a[6].getTime().sort(this._sortOhTime),a[6].getTime()[a[6].getTime().length-1]=new c.OhTime(d,b),a[0].getTime().shift());return a};c.OpeningHoursBuilder.prototype._sortOhTime=function(a,b){return a.getStart()-b.getStart()};c.OpeningHoursParser=function(){};c.OpeningHoursParser.prototype.parse=function(a){var b=[];a=a.split(";");for(var d,e,h,g,f,l,k,n,u,m,q,v,t=0,w=a.length;t<w;t++)if(d=a[t].trim(),0!==d.length){e=this._tokenize(d);h=e.length-1;g=d=null;0<=h&&this._isRuleModifier(e[h])&&(d=e[h].toLowerCase(),
		h--);k=[];if(0<=h&&this._isTime(e[h])){g=e[h];if("24/7"===g)k.push({from:0,to:1440});else for(g=g.split(","),u=0,q=g.length;u<q;u++)f=g[u].split("-"),l=this._asMinutes(f[0]),f=1<f.length?this._asMinutes(f[1]):l,k.push({from:l,to:f});h--}u=[];l=[];if("24/7"===g)l.push({from:0,to:6});else if(0<=h&&this._isWeekday(e[h])){g=e[h];g=g.split(",");q=0;for(f=g.length;q<f;q++)if(n=g[q],c.RGX_HOLIDAY.test(n))u.push(n);else if(c.RGX_WD.test(n)){n=n.split("-");var r=c.OSM_DAYS.indexOf(n[0]);n=1<n.length?c.OSM_DAYS.indexOf(n[1]):
		r;l.push({from:r,to:n})}else throw Error(p.translate("Invalid weekday interval: %s").withContext("yohours/notifications").fetch(n));h--}g=[];q=[];if(0<=h){f=e[0];for(r=1;r<=h;r++)f+=" "+e[r];if(0<f.length){f=f.replace(/:$/g,"").split("week");r=f[0].trim();0===r.length&&(r=null);1<f.length?(f=f[1].trim(),0===f.length&&(f=null)):f=null;if(null!=r&&null!=f)throw Error(p.translate("Unsupported simultaneous month and week selector").withContext("yohours/notifications").fetch());if(null!=r){r=r.split(",");
		m=0;for(var x=r.length;m<x;m++)if(f=r[m],"SH"===f)q.push({holiday:"SH"});else if(c.RGX_MONTH.test(f)){f=f.split("-");n=c.OSM_MONTHS.indexOf(f[0])+1;if(1>n)throw Error(p.translate("Invalid month: %s").withContext("yohours/notifications").fetch(f[0]));if(1<f.length){if(v=c.OSM_MONTHS.indexOf(f[1])+1,1>v)throw Error(p.translate("Invalid month: %s").withContext("yohours/notifications").fetch(f[1]));}else v=null;q.push({from:n,to:v})}else if(c.RGX_MONTHDAY.test(f)){f=f.replace(/:/g,"").split("-");n=f[0].split(" ");
			n={day:parseInt(n[1],10),month:c.OSM_MONTHS.indexOf(n[0])+1};if(1>n.month)throw Error(p.translate("Invalid month: %s").withContext("yohours/notifications").fetch(n[0]));if(1<f.length)if(v=f[1].split(" "),1===v.length)v={day:parseInt(v[0],10),month:n.month};else{if(v={day:parseInt(v[1],10),month:c.OSM_MONTHS.indexOf(v[0])+1},1>v.month)throw Error(p.translate("Invalid month: %s").withContext("yohours/notifications").fetch(v[0]));}else v=null;q.push({fromDay:n,toDay:v})}else throw Error(p.translate("Unsupported month selector: %s").withContext("yohours/notifications").fetch(f));
	}else if(null!=f)for(f=f.split(","),n=0,v=f.length;n<v;n++)m=f[n].split("-"),r=parseInt(m[0],10),m=1<m.length?parseInt(m[1],10):null,g.push({from:r,to:m});else throw Error(p.translate("Invalid date selector").withContext("yohours/notifications").fetch());}}if(h===e.length-1)throw Error(p.translate("Unreadable string").withContext("yohours/notifications").fetch());e=[];if(0<q.length)for(g=0,r=q.length;g<r;g++)f=q[g],void 0!==f.holiday?e.push((new c.WideInterval).holiday(f.holiday)):(h=void 0!==f.fromDay?
		null!=f.toDay?(new c.WideInterval).day(f.fromDay.day,f.fromDay.month,f.toDay.day,f.toDay.month):(new c.WideInterval).day(f.fromDay.day,f.fromDay.month):null!=f.to?(new c.WideInterval).month(f.from,f.to):(new c.WideInterval).month(f.from),e.push(h));else if(0<g.length)for(q=0,f=g.length;q<f;q++)h=null!=g[q].to?(new c.WideInterval).week(g[q].from,g[q].to):(new c.WideInterval).week(g[q].from),e.push(h);else if(0<u.length)for(h=0,f=u.length;h<f;h++)e.push((new c.WideInterval).holiday(u[h])),"PH"===u[h]&&
	0<l.length&&0===q.length&&0===g.length&&e.push((new c.WideInterval).always());else e.push((new c.WideInterval).always());0===l.length&&(0===u.length||1===u.length&&"SH"===u[0]?l.push({from:0,to:c.OSM_DAYS.length-1}):l.push({from:0,to:0}));0===k.length&&k.push({from:0,to:1440});u=0;for(h=e.length;u<h;u++){g=!1;for(q=0;q<b.length&&!g;)b[q].getInterval().equals(e[u])?g=!0:q++;if(g)g=b[q];else{g=new c.DateRange(e[u]);f=-1;for(q=0;q<b.length;q++)b[q].isGeneralFor(new c.DateRange(e[u]))&&(f=q);0<=f&&g.definesTypicalWeek()&&
	g.getTypical().copyIntervals(b[f].getTypical().getIntervals());b.push(g)}q=0;for(f=l.length;q<f;q++){if(l[q].from<=l[q].to)r=l[q].from;else{for(r=l[q].from;6>=r;r++)g.definesTypicalWeek()?g.getTypical().removeIntervalsDuringDay(r):g.getTypical().clearIntervals();r=0}for(;r<=l[q].to;r++)g.definesTypicalWeek()?g.getTypical().removeIntervalsDuringDay(r):g.getTypical().clearIntervals();r=0;for(n=k.length;r<n;r++)"closed"===d||"off"===d?this._removeInterval(g.getTypical(),l[q],k[r]):this._addInterval(g.getTypical(),
		l[q],k[r])}}}return b};c.OpeningHoursParser.prototype._removeInterval=function(a,b,c){if(b.from<=b.to)var d=b.from;else{for(d=b.from;6>=d;d++)this._removeIntervalWd(a,c,d);d=0}for(;d<=b.to;d++)this._removeIntervalWd(a,c,d)};c.OpeningHoursParser.prototype._removeIntervalWd=function(a,b,d){b.to>=b.from?a.removeInterval(new c.Interval(d,d,b.from,b.to)):6>d?a.removeInterval(new c.Interval(d,d+1,b.from,b.to)):(a.removeInterval(new c.Interval(d,d,b.from,1440)),a.removeInterval(new c.Interval(0,0,0,b.to)))};
	c.OpeningHoursParser.prototype._addInterval=function(a,b,d){a instanceof c.Day&&(0!==b.from||0!==b.to&&d.from<=d.to)&&(b=m.extend({},b),b.from=0,b.to=d.from<=d.to?0:1);if(b.from<=b.to)var e=b.from;else{for(e=b.from;6>=e;e++)this._addIntervalWd(a,d,e);e=0}for(;e<=b.to;e++)this._addIntervalWd(a,d,e)};c.OpeningHoursParser.prototype._addIntervalWd=function(a,b,d){b.to>=b.from?a.addInterval(new c.Interval(d,d,b.from,b.to)):6>d?a.addInterval(new c.Interval(d,d+1,b.from,b.to)):(a.addInterval(new c.Interval(d,
		...
		for(var b=m.inArray("",a);~b;)a.splice(b,1),b=m.inArray("",a);return a};c.OpeningHoursParser.prototype._printIntervals=function(a,b){console.log("From: "+a);if(0<b.length){console.log("-------------------------");for(var c=0;c<b.length;c++)void 0===b[c]?console.log(c+": undefined"):console.log(c+": "+b[c].getStartDay()+", "+b[c].getEndDay()+", "+b[c].getFrom()+", "+b[c].getTo());console.log("-------------------------")}else console.log("Empty intervals")};c.YoHoursChecker=function(){this._parser=
	...
	c.ctrl={};c.view={};c.view.DateRangeView=function(a){this._editMode=!1;this._rangeType=null;this._mainView=a;this._modal=null};c.view.DateRangeView.prototype.show=function(a){this._editMode=a||!1;var b=this,d=this._mainView.getController().getOptions();a=new x(c.templates[d.bootstrapVersion].dateRangeModal);this._modal=m(a.fetch({prefix:d.idPrefix,months:c.IRL_MONTHS,editMode:this._editMode,typicalWeek:this._mainView.getCalendarView().getDateRange().definesTypicalWeek(),start:this._mainView.getCalendarView().getDateRange().getInterval().getStart()||
			{},end:this._mainView.getCalendarView().getDateRange().getInterval().getEnd()||{},type:this._mainView.getCalendarView().getDateRange().getInterval().getType()}));this._modal.on("hidden.bs.modal",function(){m(this).remove();b._modal=null});this._modal.find(".modal-footer .btn-primary").on("click",function(){b.validate()});this._modal.find("a[role=tab]").on("shown.bs.tab",function(){b._rangeType=m(this).data("type")});this._modal.find(".month-dropdown .dropdown-menu a").on("click",function(){var a=
		m(this),b=a.closest(".month-dropdown"),g=b.find('[data-toggle="dropdown"]'),f=b.find('input[type="hidden"]'),l=b.parent().find('> input[type="number"]');f.val(a.data("value"));b.find(".dropdown-menu .active").removeClass("active");"bootstrap4"===d.bootstrapVersion?(a.addClass("active"),g.html(c.IRL_MONTHS[a.data("value")-1])):(a.parent().addClass("active"),g.html(c.IRL_MONTHS[a.data("value")-1]+' <span class="caret"></span>'));l.length&&l.prop("max",c.MONTH_END_DAY[a.data("value")-1])});this._modal.appendTo("body").modal("show")};
	c.view.DateRangeView.prototype.validate=function(){var a=this._mainView.getController().getOptions();try{switch(this._rangeType){case "month":var b=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-month-start").val());if(isNaN(b))throw Error(p.translate("Invalid start month").withContext("yohours/notifications").fetch());var d=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-month-end").val());var e=!isNaN(d)&&0<d?(new c.WideInterval).month(b,d):(new c.WideInterval).month(b);break;case "week":b=
		parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-week-start").val());if(isNaN(b)||1>b)throw Error(p.translate("Invalid start week").withContext("yohours/notifications").fetch());d=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-week-end").val());e=!isNaN(d)&&0<d?(new c.WideInterval).week(b,d):(new c.WideInterval).week(b);break;case "day":b=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-day-startday").val());if(isNaN(b)||1>b)throw Error(p.translate("Invalid start day").withContext("yohours/notifications").fetch());
		var h=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-day-startmonth").val());if(isNaN(h)||1>h)throw Error(p.translate("Invalid start month").withContext("yohours/notifications").fetch());d=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-day-endday").val());var g=parseInt(m("#"+a.idPrefix+"yo-hours-date-range-input-day-endmonth").val());if(!isNaN(d)&&0<d&&!isNaN(g)&&0<g)e=(new c.WideInterval).day(b,h,d,g);else{if(this._editMode&&this._mainView.getCalendarView().getDateRange().definesTypicalWeek())throw Error(p.translate("Missing end day").withContext("yohours/notifications").fetch());
			e=(new c.WideInterval).day(b,h)}break;case "holiday":b=m('input[name="holiday-type"]:checked',this._modal).val();if("PH"!==b&&"SH"!==b&&"easter"!==b)throw Error(p.translate("Invalid holiday type").withContext("yohours/notifications").fetch());e=(new c.WideInterval).holiday(b);break;default:e=(new c.WideInterval).always()}var f=this._mainView.getController().getDateRanges(),l=f.length;for(b=0;b<l;){if(void 0!==f[b]&&f[b].getInterval().equals(e))throw Error(p.translate("This time range is identical to another one").withContext("yohours/notifications").fetch());
		void 0!==f[b]&&f[b].isGeneralFor(new c.DateRange(e));b++}this._editMode?(this._mainView.getCalendarView().getDateRange().updateRange(e),this._mainView.getCalendarView().show(this._mainView.getCalendarView().getDateRange()),this._mainView.refresh()):this._mainView.getCalendarView().show(this._mainView.getController().newRange(e));this._modal&&this._modal.modal("hide")}catch(k){w.alert(k),console.error(k)}};c.view.CalendarView=function(a){this._mainView=a;this._dateRange=this._calendar=null};c.view.CalendarView.prototype.getDateRange=
		function(){return this._dateRange};c.view.CalendarView.prototype.updateRangeNavigationBar=function(){var a=this._mainView.getController().getOptions(),b=new x(c.templates[a.bootstrapVersion].rangeNav),d=m(b.fetch({prefix:a.idPrefix,dateRanges:this._mainView.getController().getDateRanges(),activeDateRange:this._dateRange})),e=this;d.find(".rnav > a").on("click",function(){e.show(e._mainView.getController().getDateRanges()[parseInt(m(this).data("index"))]);"bootstrap4"===a.bootstrapVersion?(d.find(".rnav > a").removeClass("active"),
		m(this).addClass("active")):(d.find(".rnav").removeClass("active"),m(this).parent().addClass("active"))});d.find("a.add").on("click",function(){e._mainView.getDateRangeView().show(!1)});m("#"+a.idPrefix+"yo-hours-range-nav").replaceWith(d)};c.view.CalendarView.prototype.updateDateRangeLabel=function(){var a=this._mainView.getController().getOptions();m("#"+a.idPrefix+"yo-hours-range-text-label").html(this._dateRange.getInterval().getTimeForHumans())};c.view.CalendarView.prototype.show=function(a){var b,
		d=this._mainView.getController().getOptions(),e=m("#"+d.idPrefix+"yo-hours-calendar");this._calendar&&this._calendar.destroy();this._dateRange=a;var h=this._dateRange.getTypical().getIntervals();a=[];var g=this;if(this._dateRange.definesTypicalWeek()){for(b=0;b<h.length;b++){var f=h[b];if(void 0!==f){var l=f.getStartDay()===f.getEndDay()&&f.getFrom()===f.getTo()?t().startOf("isoweek").day(1).hour(0).minute(0).second(0).milliseconds(0).add(f.getEndDay(),"days").add(f.getTo()+1,"minutes"):t().startOf("isoweek").day(1).hour(0).minute(0).second(0).milliseconds(0).add(f.getEndDay(),
		"days").add(f.getTo(),"minutes");var k={id:b,start:t().startOf("isoweek").day(1).hour(0).minute(0).second(0).milliseconds(0).add(f.getStartDay(),"days").add(f.getFrom(),"minutes").toDate(),end:l.toDate()};a.push(k)}}b={start:t().startOf("isoweek").day(1).format("YYYY-MM-DD[T00:00:00]"),end:t().startOf("isoweek").day(1).add(7,"days").format("YYYY-MM-DD[T00:00:00]")};h="timeGridWeek";f=this._mainView.isMinimal()?{weekday:"short"}:{weekday:"long"};l=function(a){var b=t(a.start);a=t(a.end);var d=60*parseInt(b.format("H"),
		10)+parseInt(b.format("m"),10),e=60*parseInt(a.format("H"),10)+parseInt(a.format("m"),10),f=y(b.format("d")),h=y(a.format("d"));0===d&&0===e&&1<=h-f&&(e=c.MINUTES_MAX,h--);k={id:g._dateRange.getTypical().addInterval(new c.Interval(f,h,d,e)),start:b.toDate(),end:a.toDate()};g._calendar.addEvent(k);g._mainView.refresh();g.simulateClick()};var n=function(a){a=a.event;var b=t(a.start),d=t(a.end),e=60*parseInt(b.format("H"),10)+parseInt(b.format("m"),10),f=60*parseInt(d.format("H"),10)+parseInt(d.format("m"),
		10);b=y(b.format("d"));d=y(d.format("d"));0===e&&0===f&&1<=d-b&&(f=c.MINUTES_MAX,d--);g._dateRange.getTypical().editInterval(a.id,new c.Interval(b,d,e,f));g._mainView.refresh()}}else{for(b=0;b<h.length;b++)f=h[b],void 0!==f&&(l=f.getFrom()===f.getTo()?t().hour(0).minute(0).second(0).milliseconds(0).add(f.getTo()+1,"minutes"):t().hour(0).minute(0).second(0).milliseconds(0).add(f.getTo(),"minutes"),k={id:b,start:t().hour(0).minute(0).second(0).milliseconds(0).add(f.getFrom(),"minutes").toDate(),end:l.toDate()},
		a.push(k));b={start:t().format("YYYY-MM-DD[T00:00:00]"),end:t().add(1,"days").format("YYYY-MM-DD[T00:00:00]")};h="timeGridWeek";f={day:"numeric",month:"long",year:"numeric"};l=function(a){var b=t(a.start);a=t(a.end);var d=60*parseInt(b.format("H",10))+parseInt(b.format("m"),10),e=60*parseInt(a.format("H"),10)+parseInt(a.format("m"),10);k={id:g._dateRange.getTypical().addInterval(new c.Interval(0,0,d,e)),start:b.toDate(),end:a.toDate()};g._calendar.addEvent(k);g._mainView.refresh();g.simulateClick()};
		n=function(a){a=a.event;var b=t(a.start),d=t(a.end);b=60*parseInt(b.format("H"),10)+parseInt(b.format("m"),10);d=60*parseInt(d.format("H"),10)+parseInt(d.format("m"),10);g._dateRange.getTypical().editInterval(a.id,new c.Interval(0,0,b,d));g._mainView.refresh()}}this._calendar=new FullCalendar.Calendar(e.get(0),{plugins:["timeGrid","interaction"],header:{left:"",center:"",right:""},locale:d.locale,defaultView:h,editable:!0,height:d.height,columnHeaderFormat:f,eventTimeFormat:{hour:"2-digit",minute:"2-digit"},
		allDayText:"24/24",allDaySlot:!1,slotDuration:"00:15:00",slotLabelFormat:{hour:"2-digit",minute:"2-digit"},scrollTime:"06:00:00",firstDay:1,eventOverlap:!1,events:a,eventConstraint:b,selectable:!0,selectMirror:!0,selectOverlap:!1,select:l,eventClick:function(a){g._dateRange.getTypical().removeInterval(a.event.id);a.event.remove();g._mainView.refresh()},eventResize:n,eventDrop:n});this._calendar.render();this._calendar.rerenderEvents();this.updateDateRangeLabel();this.updateRangeNavigationBar()};c.view.CalendarView.prototype.simulateClick=
		function(){var a=this._mainView.getController().getOptions();a=m("#"+a.idPrefix+"yo-hours-calendar");var b=a.offset();b=m.Event("mousedown",{which:1,pageX:b.left,pageY:b.top});a.trigger(b)};c.view.CalendarView.prototype.init=function(){var a=this,b=this._mainView.getController().getOptions();m("#"+b.idPrefix+"yo-hours-range-edit").on("click",function(){a._mainView.getDateRangeView().show(!0)});m("#"+b.idPrefix+"yo-hours-range-delete").on("click",function(){a._mainView.getController().deleteCurrentRange();
		a.show(a._mainView.getController().getFirstDateRange())})};c.view.HoursInputView=function(a,b){this._mainView=a;this._field=m(b);this._timer=null;var c=this,e=this._mainView.getController().getOptions();this._field.on("input propertychange",function(){w.clearTimeout(c._timer);c._timer=w.setTimeout(c.changedHandler.call(c),e.delay)}).on("keydown",function(a){13===a.keyCode&&(a.preventDefault(),w.clearTimeout(c._timer),c.changedHandler())})};c.view.HoursInputView.prototype.getValue=function(){return this._field.val()};
	c.view.HoursInputView.prototype.setValue=function(a){this._field.val(a)};c.view.HoursInputView.prototype.setValid=function(a){"bootstrap4"===this._mainView.getController().getOptions().bootstrapVersion?this._field.addClass(a?"is-valid":"is-invalid").removeClass(a?"is-invalid":"is-valid"):this._field.closest(".form-group").addClass(a?"has-success":"has-error").removeClass(a?"has-error":"has-success")};c.view.HoursInputView.prototype.changedHandler=function(){var a=this._field.caret();this._field.val(this._field.val().replace(/\u00e2\u0090\u00a3/gi,
		" "));this._mainView.getController().showHours(this._field.val());this._field.caret(a)};c.view.HoursInputView.prototype.init=function(){var a=this,b=this._mainView.getController().getOptions(),d=new x(c.templates[b.bootstrapVersion].inputGroup),e=this._field.parent();d=m(d.fetch({prefix:b.idPrefix,iconClock:c.templates.iconClock,iconPencil:c.templates.iconPencil,iconTrash:c.templates.iconTrash}));d.find("#toReplace").replaceWith(this._field);d.find('.btn[data-toggle="collapse"]').each(function(){m(document).on("shown.bs.collapse",
		m(this).data("target"),function(){m("#"+b.idPrefix+"yo-hours-calendar");a._mainView.getCalendarView()._calendar.render();a._mainView.getCalendarView()._calendar.rerenderEvents()})});e.append(d)};c.view.MainView=function(a,b){this._ctrl=a;var d=this._ctrl.getOptions();this._calendarView=new c.view.CalendarView(this);this._hoursInputView=new c.view.HoursInputView(this,b);this._dateRangeView=new c.view.DateRangeView(this);this._minimal=d.minimal};c.view.MainView.prototype.getHoursInputView=function(){return this._hoursInputView};
	c.view.MainView.prototype.getDateRangeView=function(){return this._dateRangeView};c.view.MainView.prototype.getCalendarView=function(){return this._calendarView};c.view.MainView.prototype.getController=function(){return this._ctrl};c.view.MainView.prototype.isMinimal=function(){return this._minimal};c.view.MainView.prototype.init=function(){this._hoursInputView.init();var a=this.getController().getOptions(),b=this._hoursInputView.getValue();void 0!==b&&""!==b.trim()?this._ctrl.showHours(b):this._calendarView.show(this._ctrl.getFirstDateRange());
		this._calendarView.init();m("#"+a.idPrefix+"yo-hours-collapse").removeClass("show in")};c.view.MainView.prototype.refresh=function(){this._hoursInputView.setValue(this._ctrl.getOpeningHours())};c.ctrl.MainController=function(a,b){this._options=m.extend({},c.options,b);this._view=new c.view.MainView(this,a);this._dateRanges=[new c.DateRange];this._builder=new c.OpeningHoursBuilder;this._parser=new c.OpeningHoursParser};c.ctrl.MainController.prototype.getOpeningHours=function(){return this._builder.build(this._dateRanges)};
	c.ctrl.MainController.prototype.getOptions=function(){return this._options};c.ctrl.MainController.prototype.getView=function(){return this._view};c.ctrl.MainController.prototype.getDateRanges=function(){return this._dateRanges};c.ctrl.MainController.prototype.getFirstDateRange=function(){for(var a=0,b=!1;a<this._dateRanges.length&&!b;)void 0!==this._dateRanges[a]?b=!0:a++;b||(this._dateRanges=[new c.DateRange],a=0);return this._dateRanges[a]};c.ctrl.MainController.prototype.init=function(){this._view.init()};
	c.ctrl.MainController.prototype.clear=function(){this._dateRanges=[new c.DateRange];this._view.getCalendarView().show(this._dateRanges[0]);this._view.refresh()};c.ctrl.MainController.prototype.newRange=function(a,b){b=b||null;var d=new c.DateRange(a);null!==b&&d.getTypical().copyIntervals(b);this._dateRanges.push(d);this._view.refresh();return d};c.ctrl.MainController.prototype.deleteCurrentRange=function(){for(var a=this._view.getCalendarView().getDateRange(),b=this._dateRanges.length,c=0;c<b;)if(this._dateRanges[c]===
		a){this._dateRanges.splice(c,1);break}else c++;this._view.getCalendarView().show(this.getFirstDateRange());this._view.refresh()};c.ctrl.MainController.prototype.showHours=function(a){this.getOptions();var b=this.getView().getCalendarView()._calendar;if(0<a.length){this._week=new c.Week;if(b){var d=b.getEvents();b.batchRendering(function(){m.each(d,function(){this.remove()})})}try{this._dateRanges=this._parser.parse(a.trim()),this._view.getCalendarView().show(this._dateRanges[0]),this._view.getHoursInputView().setValid(!0)}catch(e){console.error(e),
		this._view.getHoursInputView().setValid(!1)}this._view.getHoursInputView().setValue(a)}};m.fn.yoHours=function(a,b){this.each(function(){var d=m(this).data("yoHours");if("string"===typeof a&&d)if("function"===typeof d[a])if(b&&m.isArray(b))d[a].apply(this,b);else d[a]();else console.error(a+" is not a valid method!");else{d=m.extend({idPrefix:"yh"+ ++c.counter+"_"},c.options,a);var e=d.locale;t.locale(e);b&&"object"===typeof b&&(c.templates=m.extend({},c.templates,b));void 0===p&&c.locale&&c.locale[e]&&
	(p=new z({domain:"messages",locale_data:c.locale[e]}));d=new c.ctrl.MainController(this,d);d.init();m(this).data("yoHours",d)}});return this}})(window,jQuery,moment,YoHours,jSmart,Jed);
